...
const ABOUT_LINES: TerminalLine[] = [
  ...
  { type: 'text', content: 'Currently at NASA Kennedy Space Center developing C++ Wireshark plugins for' },
  { type: 'text', content: 'spacecraft telemetry parsing in the Launch Control System.' },
  { type: 'spacer' },
  { type: 'text', content: 'Previously built radio control interface software for multi-domain military' },
  { type: 'text', content: 'systems at CAE on a $455M General Dynamics defense contract.' },
  { type: 'spacer' },
  { type: 'text', content: "Leading autonomous navigation software for FSI's rover platform (based on" },
  { type: 'text', content: "NASA's RASSOR lunar rover) using C++, ROS2, Nav2, OpenCV, and Kubernetes." },
  { type: 'spacer' },
